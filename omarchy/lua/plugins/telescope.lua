return {
  ...
  config = function()
    ...
    map("n", "<leader>fx", builtin.treesitter, vim.tbl_extend("error", opts, { desc = "Treesitter symbols" }))
    map("n", "<leader>fs", builtin.spell_suggest, vim.tbl_extend("error", opts, { desc = "Spell suggestions" }))
  end
}
